...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ADC_READ_MODE" -widget comboBox
...
proc update_PARAM_VALUE.ADC_READ_MODE { PARAM_VALUE.ADC_READ_MODE } {
	# Procedure called to update ADC_READ_MODE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADC_READ_MODE { PARAM_VALUE.ADC_READ_MODE } {
	# Procedure called to validate ADC_READ_MODE
	return true
}
...
proc update_MODELPARAM_VALUE.ADC_READ_MODE { MODELPARAM_VALUE.ADC_READ_MODE PARAM_VALUE.ADC_READ_MODE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADC_READ_MODE}] ${MODELPARAM_VALUE.ADC_READ_MODE}
}
